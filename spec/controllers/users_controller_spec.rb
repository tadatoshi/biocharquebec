...
describe UsersController do
  ...
  describe "GET edit" do
    it "assigns the requested user as @user" do
      UserSession.stub_chain(:find, :record).and_return(mock_user)
      get :edit, :id => "37"
      assigns(:user).should be(mock_user)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      ...
      it "redirects to the created user" do
        ...
        post :create, :user => {}
        # Because the following generated by scaffold fails, it's commented out until Rspec-2 for Rails-3 becomes more stable:
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      ...
      it "assigns the requested user as @user" do
        UserSession.stub_chain(:find, :record).and_return(mock_user(:update_attributes => true))
        put :update, :id => "1"
        assigns(:user).should be(mock_user)
      end
